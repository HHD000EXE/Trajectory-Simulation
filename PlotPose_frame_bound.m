function PlotPose_frame_bound(figind, frame, xCoM, zCoM,theta, color, HalfBodyDiag, beta, LegPair)
...
%         plot(xleg(IndR)+frame,zleg(IndR),'c*','markersize',8,'linewidth',1.5);hold on;
        ...
        plot(xleg(2)+frame,zleg(2),'c*','markersize',8,'linewidth',1.5);hold on;
    else %LB, RB
...
%         plot(xleg(IndR)+frame,zleg(IndR),'bo','markersize',8,'linewidth',1.5);hold on;
        plot(xleg(4)+frame,zleg(4),'mo','markersize',8,'linewidth',1.5);hold on;

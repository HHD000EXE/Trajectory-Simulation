function PlotPose_frame_trot(figind, frame, xCoM, zCoM,theta, color, HalfBodyDiag, beta, LegPair)
...
%         plot(xleg(IndR)+frame,zleg(IndR),'c*','markersize',8,'linewidth',1.5);hold on;
        ...
        plot(xleg(3)+frame,zleg(3),'c*','markersize',8,'linewidth',1.5);hold on;
    else %RF, LB
...
%         plot(xleg(IndR)+frame,zleg(IndR),'bo','markersize',8,'linewidth',1.5);hold on;
        ...
        plot(xleg(4)+frame,zleg(4),'bo','markersize',8,'linewidth',1.5);hold on;
    end
